...
echo "-> Building native execution script loop..."
...
echo "-> Registering binary framework within global environment path scope..."
if [ -d "$INSTALL_DIR" ] && [ -w "$INSTALL_DIR" ]; then
    cp "$NOTES_DIR/gn.sh" "$INSTALL_DIR/gn"
    echo "   Installed successfully to $INSTALL_DIR/gn"
else
    echo "   Requires elevated authorization permissions to write to global binary stack..."
